...
#from ai import draw_grid
from ai import grid as ggg
import gc
...
def setup():
    ...
    layout = ggg(50,50,populated)
    #print(layout)
    start= (postOffice[0],postOffice[1]-1)
    #print("from "+str(start)+" to "+str(gls[0])+": "+str(make_path(start,gls[0],layout)))
    print(make_path(gls[4],gls[2],layout))
